...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'communities.constraint_officers': 'This community has active officers assigned and cannot be deleted.',
    'communities.constraint_residents': 'This community has active residents assigned and cannot be deleted.',
    'communities.constraint_calls': 'This community has open calls and cannot be deleted.',
    'communities.deactivate_suggestion': 'You can deactivate this community instead, which will disable access without removing the data.',
    'communities.deactivate_action': 'Deactivate Instead',
