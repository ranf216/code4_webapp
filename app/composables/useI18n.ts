...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'nav.tasks': 'Tasks',
    'nav.map_assets': 'Map & Assets',
    'nav.map_workspace': 'Map Workspace',
    'nav.posts': 'Posts',
    ...
    'communities.clear_boundary': 'Clear',
    ...
    'map.active_only': 'Active',
    'map.items_total': 'total items',
    'map.created': 'Created',
    ...
    'map.shape_line': 'Line',
    'map.shape_polygon': 'Polygon',
    'map.entity_type': 'Item type',
    'map.hint_select_entity': 'Select Asset, Post or Zone first',
    'map.hint_select_shape': 'Select a drawing shape',
    'map.finish': 'Finish',
    'map.undo': 'Undo',
    ...
    'map.hint_circle': 'Click and drag to set the radius',
    'map.hint_line': 'Click to add waypoints, double-click to finish',
    'map.hint_polygon': 'Click to add vertices, double-click to close',
    'map.legend': 'Legend',
    'map.assets': 'Assets',
    'map.posts': 'Posts',
    'map.total_items': '{count} total items',
    'map.items_counter': 'Items: {current} / {limit}',
    'map.items_limit_tooltip': 'Map item limit reached. Delete existing items or contact an administrator to increase the limit.',
    'map.limit_exceeded_title': 'Map Item Limit Exceeded',
    'map.limit_exceeded_message': 'Adding these items would bring the total to {total} / {limit}.',
    'map.limit_exceeded_hint': 'Please reduce the batch or remove existing items.',
    'map.batch_limit_title': 'Batch Limit Exceeded',
    'map.batch_limit_message': 'A batch can contain at most {max} locations.',
    'map.batch_limit_toast': 'A batch is limited to {max} locations',
    'map.upload_map': 'Upload Map',
    'map.upload_map_title': 'Upload Community Map',
    'map.map_base': 'Map Base',
    'map.google_map': 'Google Map',
    'map.community_image': 'Community Image',
    'map.map_image': 'Map Image',
    'map.drop_image_here': 'Drag & drop a map image here, or click to browse',
    'map.supported_formats': 'Accepted formats: PNG, JPG',
    'map.invalid_image_type': 'Please select a PNG or JPG image',
    ...
    'map.post_name_exists': 'A post with this name already exists in the selected community.',
    ...
    'map.eligibility_requirements': 'Scheduling Eligibility Requirements',
    'map.required_roles': 'Required Roles',
    'map.required_badges': 'Required Badges',
    'map.required_equipment': 'Required Equipment',
    'map.add_equipment_hint': 'Press Enter to add',
    'map.active': 'Active',
    'map.chars': 'chars',
    ...
    'map.cannot_delete_post_title': 'Cannot Delete Post',
    'map.cannot_delete_post_message': '"{name}" has been used in shift scheduling and cannot be deleted. You can deactivate it instead to hide it from scheduling.',
    'map.deactivate_post': 'Deactivate Post',
    ...
    'map.zone_name_max': 'Zone name must be 100 characters or less',
    'map.zone_type': 'Zone Type',
    'map.zone_placeholder': 'e.g., VIP Area, Server Room',
    'map.add_zone_title': 'Add Map Zone',
    'map.edit_zone_title': 'Edit Map Zone',
    'map.polygon': 'Polygon',
    'map.points': 'points',
    ...
    'calls.call_id': 'Call ID',
    'calls.current_address': 'Current Address',
    'calls.priority': 'Priority',
    'calls.assigned_officer': 'Assigned Officer',
    'calls.unassigned': 'Unassigned',
    'calls.accepted_on': 'Accepted On',
    'calls.resolved_on': 'Resolved On',
    'calls.coordinates': 'Coordinates',
    'calls.media': 'Media',
    'calls.audio_recording': 'Audio Recording',
    'calls.video': 'Video',
    'calls.open_audio': 'Open audio',
    'calls.open_video': 'Open video',
    ...
    'calls.assign': 'Assign',
    'calls.assigning': 'Assigning...',
    'calls.select_officer': 'Select Officer',
    'calls.select_officer_placeholder': 'Choose an active officer',
    'calls.officers_load_failed': 'Failed to load officers.',
    'calls.assign_failed': 'Failed to assign officer.',
    'calls.resolve_panic': 'Resolve Panic Call',
    'calls.resolving': 'Resolving...',
    'calls.resolve_failed': 'Failed to resolve panic call.',
    'calls.security_notice_label': 'Security Notice:',
    'calls.panic_security_notice': 'Please confirm that safety has been verified via direct communication with the officer on scene.',
    'calls.safety_confirmed': 'I confirm that the safety situation has been verified.',
    'calls.confirmation_photos': 'Confirmation Photos (max 5)',
    'calls.confirmation_video': 'Confirmation Video (max 1)',
    'calls.confirmation_photos_hint': 'Upload up to 5 confirmation photos.',
    'calls.confirmation_video_hint': 'Upload one confirmation video.',
    'calls.resolve_comments_placeholder': 'Optional comments...',
    ...
    // Panic Call
    'calls.panic_call_not_found': 'No active panic call found.',
    'calls.panic_call_load_failed': 'Failed to load panic call details.',
    ...
    'shifts.interval_days': 'Every X Days',
    ...
    'shifts.allocated_officers': 'Allocated Officers',
    'shifts.officers_assigned': 'officers assigned',
    'shifts.add_officer': 'Add Officer',
    'shifts.officer': 'Officer',
    'shifts.remove_officer': 'Remove Officer',
    'shifts.no_officers_assigned': 'No officers have been allocated to this shift.',
    'shifts.allocate_failed': 'Failed to allocate officer.',
    'shifts.remove_failed': 'Failed to remove officer.',
    'shifts.remove_officer_title': 'Remove Officer',
    'shifts.remove_officer_message': 'Are you sure you want to remove {name} from this shift?',
    'shifts.acknowledge_allocate': 'Acknowledge & Allocate',
    'shifts.select_post': 'Select Post',
    'shifts.assign_post': 'Assign Post',
    'shifts.assigning_post': 'Assigning...',
    'shifts.no_post_assigned': 'No post assigned',
    'shifts.post_eligibility_warning': 'Eligibility warning',
    'shifts.missing_roles': 'Missing required roles',
    'shifts.missing_badges': 'Missing required badges',
    'shifts.assign_post_failed': 'Failed to assign post.',
    'shifts.checkin_history': 'Check-In History',
    'shifts.checkin_records': 'records',
    'shifts.check_in_time': 'Check-in Time',
    'shifts.check_out_time': 'Check-out Time',
    'shifts.total_hours': 'Total Hours',
    'shifts.auto_checkout': 'Auto-checkout',
    'shifts.checkin_notes': 'Notes',
    'shifts.still_active': 'Still active',
    'shifts.no_checkin_records': 'No check-in records.',
    'shifts.search_placeholder': 'Search officers or communities...',
    'shifts.load_failed': 'Failed to load shift calendar.',
    'shifts.details_load_failed': 'Failed to load shift details.',
    'shifts.required_fields_error': 'Community, date, start time, and end time are required.',
    'shifts.same_time_error': 'Start time and end time cannot be the same.',
    'shifts.notes_max_error': 'Notes cannot exceed 500 characters.',
    'shifts.save_failed': 'Failed to save shift.',
    'shifts.next_day': '(next day)',
    'shifts.repeat_on_required': 'Select at least one day of the week.',
    'shifts.interval_days_error': 'Every X Days must be at least 2 days.',
    'shifts.end_date_required': 'End date is required.',
    'shifts.occurrences_error': 'Occurrences must be between 1 and 365.',
    'shifts.no_end_notice': 'Shifts will be generated on a rolling 90-day horizon. The system automatically extends the series as time progresses.',
    'shifts.recurring_update_title': 'Update Recurring Shift',
    'shifts.scope_this_only': 'This shift only',
    'shifts.scope_this_only_description': 'Changes apply only to this shift.',
    'shifts.scope_this_future': 'This and future shifts',
    'shifts.scope_this_future_description': 'Changes apply to this shift and all future shifts in the series.',
    'shifts.scope_all': 'All shifts in series',
    'shifts.scope_all_description': 'Changes apply to all draft and published shifts in the series.',
    'shifts.recurring_update_failed': 'Failed to update recurring shifts.',
    'shifts.routes_count': 'routes',
    'shifts.auto_generated': 'Auto-generated',
    'shifts.publish': 'Publish',
    'shifts.publishing': 'Publishing...',
    'shifts.publish_failed': 'Failed to publish shift.',
    'shifts.cancel_shift': 'Cancel Shift',
    'shifts.cancelling': 'Cancelling...',
    'shifts.cancel_title': 'Cancel Shift',
    'shifts.cancel_message': 'Are you sure you want to cancel Shift #{id}? Allocated officers will be notified.',
    'shifts.cancel_failed': 'Failed to cancel shift.',
    'shifts.delete_title': 'Delete Shift',
    'shifts.delete_message': 'Are you sure you want to delete draft Shift #{id}? This action cannot be undone.',
    'shifts.delete_failed': 'Failed to delete shift.',
    'shifts.conflict_title': 'Scheduling Conflicts Detected',
    'shifts.conflict_default': 'This shift has a scheduling conflict.',
    'shifts.conflict_acknowledgment': 'I acknowledge these conflicts and wish to proceed.',
    'shifts.acknowledge_publish': 'Acknowledge & Publish',
    'shifts.complete': 'Complete',
    'shifts.notes_placeholder': 'Enter notes visible to officers',
    'shifts.allocation_board': 'Allocation Board',
    'shifts.allocation_board_load_failed': 'Failed to load allocation board.',
    'shifts.live_shift_monitor': 'Live Shift Monitor',
    'shifts.live_monitor_load_failed': 'Failed to load active shifts.',
    'shifts.no_active_shifts': 'No active shifts.',
    'shifts.last_updated': 'Updated',
    'shifts.shift_time': 'Shift Time',
    'shifts.elapsed': 'Elapsed',
    'shifts.not_checked_in': 'Not checked in',
    'shifts.unfulfilled_posts': 'Unfulfilled Posts',
    'shifts.all_posts_fulfilled': 'All posts fulfilled',
    ...
    'notifications.filter.from_date': 'From date',
    'notifications.filter.to_date': 'To date',
    'notifications.col.status': 'Status',
    'notifications.col.type': 'Type',
    'notifications.col.content': 'Content',
    'notifications.col.time': 'Time',
